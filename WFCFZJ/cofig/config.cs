...
namespace GrabSmm.cofig
{
    public class config
    {
        ...
        public static string GetBrower(string jdaddress)
        {
            ...
            List<GrabSmm.cofig.Headers> lmhd = jsshd.Deserialize<List<GrabSmm.cofig.Headers>>(File.ReadAllText(jdaddress));//System.Web.HttpContext.Current.Server.MapPath("../json/headers.json")
        ...
        public static string GetRequestUrl(string jdaddress)
        {
            ...
            List < GrabSmm.cofig.Link> link = jsshd.Deserialize< List<GrabSmm.cofig.Link>>(File.ReadAllText(jdaddress));
